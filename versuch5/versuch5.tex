...
\end{framed}
\noindent
In Abbildung \ref{fig:Konvergenz_time} ist die Konvergenz des relativen Fehlers im Zeitbereich dargestellt. Es ist zu erkennen, dass das Verfahren mit 1. Ordnung konvergiert.
\begin{figure}[h]
	\centering
