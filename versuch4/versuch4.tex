...
\end{framed}
Um die Kapazität eines Platenkondensators auszurechnen, benutzt man diese Formel:
$$\text{C}=\varepsilon_r\varepsilon_0\frac{A}{l} $$
$\text{A}$ bezeichnet Fläche einer Platte und $\text{l}$ die Abstand zwischen zweier Platten.
