...
$	\begin{pmatrix}
	...
	\\
	\\
	Eine Formel für die Oberfläche des diskreten Zylinders($A_\text{disc}$) erhält man mit der Summation über alle Dreiecksflächen. Die Oberfläche besteht aus 2 Grundflächen ($2\cdot n_\text{D}A_\text{D}$) und einem Mantel ($2\cdot\frac12  a_\text{D}h$).\\
