...
Ranpunkte sind die Punkte, die an der Rand des Rechengebietes liegen. Um es zu finden, sollte man kanonische Nummerierung und deren Indizies benutzen. Randpunkt ist jedes Punkt, dessen Index gleich 1 oder bei Definition maximal möglich ist.
Hierfür ist ein Pseudocode geschrieben. 



  
\begin{lstlisting}[caption={Randpunkte },label={lst:mgn_RB}]
Randpunkte=[];
Mx=1;
My=nx;
Mz=nx*ny;
