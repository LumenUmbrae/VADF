...
\begin{document}
	...
	\end{eqnarray*}
	Mit (I) und (\ref{eq:ansatz}) folgt direkt $c_1=0$. Mit (II) und (\ref{eq:ansatz}) folgt $c_2$sin$(k_xL)=0$. Damit dies erfüllt wird muss $k_x=\frac{n\pi}{L}$ mit $n \in\mathbb{Z}$ gelten. Mit $c_2=0$ wäre die triviale Nulllösung erreicht. Die kleinste Wellenzahl ist damit $k_x=\frac{\pi}{L}$.\\
	\\
	...
	Das Konvergenzverhalten wird durch die nicht gegebenen Randbedingungen schlechter.
